...
def scrapeo(url, players, prices,dorsales,paises,edades,posiciones,playersExcel,valuesExcel,dorsalExcel,paisExcel,edadExcel,posicionExcel):
    ...
    d = ({"Players": players, "Dorsal": dorsales, "Valor": prices,"Edad":edades,"Pais":paises,"Posicion":posiciones})
    dataDos = ({"Players": playersExcel, "Dorsal": dorsalExcel, "Valor": valuesExcel,"Edad":edadExcel,"Pais":paisExcel,"Posicion":posicionExcel})
...
for clave in urlTeamsLaliga:
    ...
    print(valor)
    scrapeo(urlTransfermark + urlTeamsLaliga[clave], PlayersList, ValuesList,DorsalList,PaisList,EdadList,PosicionList,PlayersExcel,ValuesExcel,DorsalExcel,PaisExcel,EdadExcel,PosicionExcel)
    PlayersList = list()
    ValuesList = list()
    DorsalList = list()
    PaisList=list()
